...
- Warna label nama grid dan label kode titik dibedakan supaya keduanya mudah dibedakan sekilas di peta. Garis batas dan isian tiap area grid juga diberi warna berbeda satu sama lain (dapat dimatikan) supaya batas antar area mudah dikenali; saat sedang menampilkan progres sebagian atau kendala, isian tetap mengikuti warna status pengerjaan di lokasi tersebut
...
- Lokasi sampling aktual ditandai dengan warna biru dan garis tepi kuning tua di peta, kontras dari warna status lainnya
