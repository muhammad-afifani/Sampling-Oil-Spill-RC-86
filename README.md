...
- Titik yang belum disampling berkedip pelan di peta, supaya titik-titik yang masih tersisa mudah terlihat sekilas
- Bagian area grid yang catatan kendalanya sudah diisi (atau ditandai bermasalah) ditampilkan dengan arsiran garis miring di lokasi titik tersebut, terpisah dari warna status pengerjaan
