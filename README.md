...
- Tombol Ekspor PDF di atas peta mencetak peta beserta legenda, ringkasan progres, dan informasi koordinat (lewat dialog cetak/Save as PDF bawaan browser), dengan tata letak mengikuti contoh lembar survei perusahaan. Lokasi sampling aktual sengaja tidak disertakan pada peta ini. Koordinat pada lembar cetak memakai referensi WGS 84 (lintang/bujur) dari data aplikasi, bukan grid lokal survei internal
