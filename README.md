...
- Rekap Data Titik: tabel berisi seluruh titik sampling (kode, jenis, grid, status dan tanggal Before/After Recovery, kendala, personil), mengikuti pencarian dan filter status yang aktif di toolbar. Setiap baris dapat diklik untuk langsung membuka detail titik tersebut, ditampilkan di bawah Ringkasan Area Grid
